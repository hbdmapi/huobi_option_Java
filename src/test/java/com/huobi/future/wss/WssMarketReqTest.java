...
public class WssMarketReqTest {
    ...
    public void test1() throws URISyntaxException, InterruptedException {
        ...
        while (true) {
            try {
                Date fromDate = DateUtils.parseDate("2020-07-15T00:00:00", "yyyy-MM-dd'T'HH:mm:ss");
                Date toDate = DateUtils.parseDate("2020-08-30T00:00:01", "yyyy-MM-dd'T'HH:mm:ss");

                KLineSubRequest kLineSubRequest = KLineSubRequest.builder()
                        .req("market.BTC-USDT-200814-C-9500.kline.60min")
    ...
    public void test2() throws URISyntaxException, InterruptedException {
        ...
        while (true) {
            try {
                ...
                param.put("req", "market.BTC-USDT-200814-C-9500.trade.detail");
