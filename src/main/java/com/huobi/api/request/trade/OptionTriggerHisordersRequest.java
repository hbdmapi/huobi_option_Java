...
@AllArgsConstructor
@Builder
public class OptionTriggerHisordersRequest {
    private String symbol;//"BTC","ETH"...
    private String tradePartition;//"USDT"
    private String contractCode;//"BTC-USDT-200508-C-8800"
    private Integer tradeType;//0:全部,1:买入开多,2: 卖出开空,3: 买入平空,4: 卖出平多；后台是根据该值转换为offset和direction，然后去查询的； 其他值无法查询出结果
    private String status;//多个以英文逗号隔开，计划委托单状态：0:全部（表示全部结束状态的订单）、4:已委托、5:委托失败、6:已撤单
    private Long createDate;//可随意输入正整数，如果参数超过90则默认查询90天的数据
